package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarRegistroAdicionalAppCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getRegistracionAdicionalApp(modelo.clienteSeleccionado.titular.idCliente);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.adicionalAppRegistro = data.result;
