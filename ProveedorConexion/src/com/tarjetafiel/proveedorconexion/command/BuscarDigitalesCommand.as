package com.tarjetafiel.proveedorconexion.command
{
	...
	public class BuscarDigitalesCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getDocAdjuntosById(modelo.clienteSeleccionado.titular.idCliente);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaDigitales = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
