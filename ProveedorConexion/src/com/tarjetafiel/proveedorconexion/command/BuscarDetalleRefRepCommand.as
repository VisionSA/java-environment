package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarDetalleRefRepCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.detalleRefRep(modelo.clienteSeleccionado.titular.idCliente);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaRefRep = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
