package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarReclamosCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getReclamosByNroDocumento(modelo.clienteSeleccionado.titular.individuo.nroDocumento);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaReclamos = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
