package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarRegistroTitularAppCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getRegistracionTitularApp(modelo.clienteSeleccionado.titular.idCliente);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.titularAppRegistro = data.result;
