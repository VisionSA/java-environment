package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarCorrienteResumenFechaCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.cuentaCorrienteResumenFecha(modelo.clienteSeleccionado.titular.idCliente,modelo.fechaResumen);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaCorrienteResumen= new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
