package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarCorrienteResumenCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.cuentaCorrienteResumen(modelo.clienteSeleccionado.titular.idCliente);
