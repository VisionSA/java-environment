package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarDetallePagoGestionCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.detallePagoGestion(modelo.gestorCuentaNew.idCliente,modelo.gestorCuentaNew.fechaEjecucion);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaPagoGestion = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
