package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarHistLineaCreditoCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getLineaCerdHistoricoByIdCliente(modelo.clienteSeleccionado.titular.idCliente);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaHistLineaCredito = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
			new ClientesGeneralEvent(ClientesGeneralEvent.BUSCAR_LINEACREDITO_EVENT,null,null).dispatch();
