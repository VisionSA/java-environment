package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarLineaCreditoCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getValoresAdelantoEfectivo(modelo.clienteSeleccionado.titular.idCliente);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaLineaCredito = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
			
			new ClientesGeneralEvent(ClientesGeneralEvent.BUSCAR_LINEA_CREDITO_TEMPORAL_EVENT,null,null).dispatch();
