package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarControlClienteCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getControlClientes(modelo.operador);
		...
		public function result(data:Object):void {
			...
			modelo.listaControlClientes = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
