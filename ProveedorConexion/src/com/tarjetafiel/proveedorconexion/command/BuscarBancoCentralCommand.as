package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarBancoCentralCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getBCRAByNroCuil(modelo.clienteSeleccionado.titular.individuo.cuil);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaBancoCentral = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
