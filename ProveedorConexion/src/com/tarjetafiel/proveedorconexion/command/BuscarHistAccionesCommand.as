package com.tarjetafiel.proveedorconexion.command {
	...
	public class BuscarHistAccionesCommand implements ICommand, IResponder {
		...
		public function execute(event:CairngormEvent):void {
			...
			var pendingCall:AsyncToken = ro.getListaTareasByIdCliente(modelo.clienteSeleccionado.titular.idCliente);
			pendingCall.addResponder(this);
		}
		
		public function result(data:Object):void {
			modelo.listaAccionesCliente = new ArrayCollection(ArrayUtil.toArray(ResultEvent(data).result));
