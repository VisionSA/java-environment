...
public class Lote  implements Negocio{
	...
	public final static String LOTE = "t_cont_lote_c";
	...
	public final static String ID_CONCEPTO = "c_concepto";
	public final static String TIPO_ASIENTO = "c_tipo_asiento";
	...
	public final static String HORA_CARGA = "c_hora_carga";
	...
	public Lote(Integer idEmpresa, Integer idEjercicio, Long idAsiento, String concepto,
			Integer idTipoAsiento, Date fechaContab, Date fechaCarga, Timestamp horaCarga,
			String operador) {
		setIdEmpresa(idEmpresa);
		setIdEjercicio(idEjercicio);
		setIdAsiento(idAsiento);
		setConcepto(concepto);
		setIdTipoAsiento(idTipoAsiento);
		setFechaContab(fechaContab);
		setFechaCarga(fechaCarga);
		setHoraCarga(horaCarga);
