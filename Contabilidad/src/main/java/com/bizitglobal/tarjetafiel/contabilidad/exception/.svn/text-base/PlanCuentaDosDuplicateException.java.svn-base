...
*/
public class PlanCuentaDosDuplicateException extends PlanCuentaDosException {


	/**
	 * 
	 */
	private static final long serialVersionUID = -6990284825559955857L;
	...
	*/
	public PlanCuentaDosDuplicateException (String msg, Throwable cause) {
		super(msg,cause);
	}
}
