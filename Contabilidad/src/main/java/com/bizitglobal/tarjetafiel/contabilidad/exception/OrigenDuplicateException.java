...
*/
public class OrigenDuplicateException extends OrigenException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4814716407465951208L;
	...
	*/
	public OrigenDuplicateException (String msg, Throwable cause) {
		super(msg,cause);
	}
}
