...
*/
public class AsientoComercioException extends Exception {
		...
		*/
		public AsientoComercioException (String msg) {
		...
		*/
		public AsientoComercioException (String msg, Throwable cause) {
