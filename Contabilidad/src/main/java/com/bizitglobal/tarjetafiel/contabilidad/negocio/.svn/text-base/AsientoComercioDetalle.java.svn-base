...
public class AsientoComercioDetalle extends AsientoDetalleBase {
	
	private Long comprobante;
	private Long numeroImputaHaber;
	
	public final static String TRA_ASIENTO_CTACTE_CLIENTE = "t_vis_tra_ctacte_comercios";
	public final static String DETALLE_COMPROBANTE = "c_id_ctacte_comercio";
