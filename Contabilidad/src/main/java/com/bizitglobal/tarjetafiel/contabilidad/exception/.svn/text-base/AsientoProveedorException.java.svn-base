...
*/
public class AsientoProveedorException extends Exception {
		...
		*/
		public AsientoProveedorException (String msg) {
		...
		*/
		public AsientoProveedorException (String msg, Throwable cause) {
