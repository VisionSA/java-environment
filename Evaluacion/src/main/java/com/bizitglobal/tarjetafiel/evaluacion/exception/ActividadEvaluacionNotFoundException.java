...
*/
public class ActividadEvaluacionNotFoundException extends ActividadEvaluacionException {
	...
	*/
	public ActividadEvaluacionNotFoundException (String msg, Throwable cause) {
