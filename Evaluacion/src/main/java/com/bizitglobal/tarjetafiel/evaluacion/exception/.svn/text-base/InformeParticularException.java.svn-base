...
*/
public class InformeParticularException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public InformeParticularException (String msg) {
	...
	*/
	public InformeParticularException (String msg, Throwable cause) {
