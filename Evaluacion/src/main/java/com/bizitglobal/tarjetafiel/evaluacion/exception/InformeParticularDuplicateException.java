...
*/
public class InformeParticularDuplicateException extends InformeParticularException {
	...
	*/
	public InformeParticularDuplicateException (String msg, Throwable cause) {
