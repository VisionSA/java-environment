...
*/
public class VerificadorTelefonoDuplicateException extends VerificadorTelefonoException {
	...
	*/
	public VerificadorTelefonoDuplicateException (String msg, Throwable cause) {
