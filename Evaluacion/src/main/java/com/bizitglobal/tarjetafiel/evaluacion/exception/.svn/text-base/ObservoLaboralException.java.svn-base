...
*/
public class ObservoLaboralException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public ObservoLaboralException (String msg) {
	...
	*/
	public ObservoLaboralException (String msg, Throwable cause) {
