...
*/
public class ObservoSucursalException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public ObservoSucursalException (String msg) {
	...
	*/
	public ObservoSucursalException (String msg, Throwable cause) {
