...
*/
public class IndividuoDomicilioDuplicateException extends IndividuoDomicilioException {
	...
	*/
	public IndividuoDomicilioDuplicateException (String msg, Throwable cause) {
