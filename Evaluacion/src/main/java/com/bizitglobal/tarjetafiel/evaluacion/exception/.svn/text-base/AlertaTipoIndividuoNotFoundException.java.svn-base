...
*/
public class AlertaTipoIndividuoNotFoundException extends AlertaTipoIndividuoException {
	...
	*/
	public AlertaTipoIndividuoNotFoundException (String msg, Throwable cause) {
