...
*/
public class SolicitudIndividuoDuplicateException extends SolicitudIndividuoException {
	...
	*/
	public SolicitudIndividuoDuplicateException (String msg, Throwable cause) {
