...
*/
public class ActividadEvaluacionException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public ActividadEvaluacionException (String msg) {
	...
	*/
	public ActividadEvaluacionException (String msg, Throwable cause) {
