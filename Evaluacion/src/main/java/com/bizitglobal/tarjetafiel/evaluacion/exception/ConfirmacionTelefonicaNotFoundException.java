...
*/
public class ConfirmacionTelefonicaNotFoundException extends ConfirmacionTelefonicaException {
	...
	*/
	public ConfirmacionTelefonicaNotFoundException (String msg, Throwable cause) {
