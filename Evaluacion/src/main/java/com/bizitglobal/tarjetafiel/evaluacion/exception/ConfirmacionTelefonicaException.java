...
*/
public class ConfirmacionTelefonicaException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public ConfirmacionTelefonicaException (String msg) {
	...
	*/
	public ConfirmacionTelefonicaException (String msg, Throwable cause) {
