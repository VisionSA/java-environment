...
*/
public class EsquemaIndividuoDuplicateException extends EsquemaIndividuoException {

	private static final long serialVersionUID = -828573055727121114L;
	...
	*/
	public EsquemaIndividuoDuplicateException (String msg, Throwable cause) {
