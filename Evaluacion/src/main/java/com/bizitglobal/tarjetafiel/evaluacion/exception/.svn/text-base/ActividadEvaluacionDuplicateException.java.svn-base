...
*/
public class ActividadEvaluacionDuplicateException extends ActividadEvaluacionException {
	...
	*/
	public ActividadEvaluacionDuplicateException (String msg, Throwable cause) {
