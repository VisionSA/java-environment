...
*/
public class ConfirmacionTelefonicaDuplicateException extends ConfirmacionTelefonicaException {
	...
	*/
	public ConfirmacionTelefonicaDuplicateException (String msg, Throwable cause) {
