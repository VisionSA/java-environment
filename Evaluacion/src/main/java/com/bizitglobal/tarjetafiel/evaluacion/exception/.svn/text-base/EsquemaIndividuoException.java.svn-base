...
*/
public class EsquemaIndividuoException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public EsquemaIndividuoException (String msg) {
	...
	*/
	public EsquemaIndividuoException (String msg, Throwable cause) {
