...
*/
public class IndividuoEvaluacionDuplicateException extends IndividuoEvaluacionException {
	...
	*/
	public IndividuoEvaluacionDuplicateException (String msg, Throwable cause) {
