...
*/
public class IndividuoVehiculoException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public IndividuoVehiculoException (String msg) {
	...
	*/
	public IndividuoVehiculoException (String msg, Throwable cause) {
