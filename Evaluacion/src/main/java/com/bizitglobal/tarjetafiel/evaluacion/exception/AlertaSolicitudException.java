...
*/
public class AlertaSolicitudException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public AlertaSolicitudException (String msg) {
	...
	*/
	public AlertaSolicitudException (String msg, Throwable cause) {
