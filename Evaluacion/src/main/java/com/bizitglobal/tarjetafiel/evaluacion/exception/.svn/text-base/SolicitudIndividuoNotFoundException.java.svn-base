...
*/
public class SolicitudIndividuoNotFoundException extends SolicitudIndividuoException {
	...
	*/
	public SolicitudIndividuoNotFoundException (String msg, Throwable cause) {
