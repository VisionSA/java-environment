...
*/
public class AlertaTipoIndividuoDuplicateException extends AlertaTipoIndividuoException {
	...
	*/
	public AlertaTipoIndividuoDuplicateException (String msg, Throwable cause) {
