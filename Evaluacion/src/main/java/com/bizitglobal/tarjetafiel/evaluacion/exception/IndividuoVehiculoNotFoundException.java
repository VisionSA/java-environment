...
*/
public class IndividuoVehiculoNotFoundException extends IndividuoVehiculoException {
	...
	*/
	public IndividuoVehiculoNotFoundException (String msg, Throwable cause) {
