...
*/
public class IndividuoDomicilioNotFoundException extends IndividuoDomicilioException {
	...
	*/
	public IndividuoDomicilioNotFoundException (String msg, Throwable cause) {
