...
*/
public class IndividuoVehiculoDuplicateException extends IndividuoVehiculoException {
	...
	*/
	public IndividuoVehiculoDuplicateException (String msg, Throwable cause) {
