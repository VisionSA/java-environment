...
*/
public class VerificadorTelefonoNotFoundException extends VerificadorTelefonoException {
	...
	*/
	public VerificadorTelefonoNotFoundException (String msg, Throwable cause) {
