...
*/
public class InfoParticularVehiculoNotFoundException extends InfoParticularVehiculoException {
	...
	*/
	public InfoParticularVehiculoNotFoundException (String msg, Throwable cause) {
