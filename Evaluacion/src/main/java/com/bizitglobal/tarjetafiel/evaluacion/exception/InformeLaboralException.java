...
*/
public class InformeLaboralException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public InformeLaboralException (String msg) {
	...
	*/
	public InformeLaboralException (String msg, Throwable cause) {
