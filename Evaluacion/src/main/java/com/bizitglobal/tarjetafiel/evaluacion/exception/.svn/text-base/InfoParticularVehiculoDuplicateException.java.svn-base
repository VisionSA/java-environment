...
*/
public class InfoParticularVehiculoDuplicateException extends InfoParticularVehiculoException {
	...
	*/
	public InfoParticularVehiculoDuplicateException (String msg, Throwable cause) {
