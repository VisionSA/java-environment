...
public class CierreCuentaClienteBean extends BaseBean {
	...
	/* @I4629 */private boolean mostrarItems;
	/* @F4629 */private List listaMotivosList;
	...
	/* @I4629 */private List<PlasticoLugar> listPlasticoLugar;
	...
	/* @I4629 */private List<String> mensajesError;
	...
	/* @I4629 */public boolean isMostrarItems() {
		return mostrarItems;
	}
	...
	/* @I4629 */public HtmlSelectOneMenu getMotivoHtml() {
		return motivoHtml;
	}
	...
	/* @I4629 */public List getMensajesError() {
	...
	/* @I4629 */public String irALiquidar() {
	...
	public void ConfirmarCierre() {
		/* @I4629 */if (this.cierreCuentaCliente.getMotivoCierre() != null) {
			try {
				transaccionesService.getCierreCuentaClienteService().confirmarCierreCuentaCliente(titular, adic, cierreCuentaCliente,
						Session.getOperador());
	...
	/* @I4629 */public boolean getOrigen() {
		return origen;
	}
	...
	public String irAContinuar() {
		popup.borrar();
		/* @I4629 */this.liq.getPopup().borrar();
		// borrar();
	...
	public void inicializarParametros(Map param) {
		...
		/* @I4629 */// BUSCO EL TITULAR DE LA CUENTA//
	...
	public void borrar() {
		...
		/* @I4629 */this.mostrarItems = false;
		this.mostrarFormulario = false;
		this.mensajesError = new ArrayList<String>();
		/* @F4629 */// this.plasticosTitular = null;
	...
	public String buscarCuentaCliente() {
		...
		try {
			...
			// VALIDACIONES//
			if (this.titular.getEstadoCliente().getIdEstadoCliente() != 1) {
				mensajesError.add("La cuenta no se encuentra en estado normal.");
			}
			if (this.titular.getEstadoCobranza().getIdEstadoCobranza() != 1) {
				mensajesError.add("La cuenta no se encuentra en una situacion comercial normal.");
			}
			if (saldo != 0) {
				mensajesError.add("La cuenta no se encuentra con saldo 0(cero).");
			} else {
				List listaItemsLiquidaciones = transaccionesService.getItemLiquidacionService().getItemsDeLiquidacion(
						Integer.parseInt(nroCuenta.toString()));
				if (!listaItemsLiquidaciones.isEmpty()) {
					mostrarItems = true;
					mensajesError.add("No se puede efectuar el cierre de cuenta, ya que, se encontraron items en la cuenta sin liquidar");
			...
			/* @F4629 */
				...
				/* @I4629 */this.listPlasticoLugar = transaccionesService.getPlasticoLugarService().listar(f);
				origen = true;
				/* @F4629 */}

			/* @I4629 */} catch (CtaCteClienteException e) {
			/* @F4629 */e.printStackTrace();
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
	...
	public String generarCertificado() {
		try {
			...
			/* @I4629 */String p3 = "&fechaHoy=" + Fecha.getFechaFormatoEspanol().trim();
			String page = request.getContextPath() + "/report/certificado_libre_deuda.jrxml";
			/* @F4629 */popupReport = "popup('" + page + p1 + p2 + p3 + "',1000,600)";
			log.info(popup);
	...
	public String generarComprobante() {
		try {
			...
			/* @I4629 */String p4 = "&mes=" + Util.nombreMes(c.get(Calendar.MONTH) + 1);
			/* @F4629 */String p5 = "&year=" + c.get(Calendar.YEAR);

			String page = request.getContextPath() + "/report/Comprobante_Cierre_Cuenta_Cliente.jrxml";
	...
	/* @I4629 */public void cambiarLugar(ValueChangeEvent event) {
