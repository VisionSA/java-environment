...
public class InformesBean extends BaseBean {
	...
	public String inicializarConsultaTransferencia() {
		borrarConceptoMensual();
		// borrarComercio();

		tituloLargo = "INFORMES";
		tituloCorto = "Consultas transferencias Link";

		return "detalleConsultaTransferencia";
	}
	
	public String inicializarTransferenciaError() {
		borrarConceptoMensual();
		// borrarComercio();

		tituloLargo = "INFORMES";
		tituloCorto = "Consultas Transferencias Errorneas";

		return "transferenciasLinkError";
	}
	
	public String inicializarTransferenciaComercio() {
		borrarConceptoMensual();
		// borrarComercio();

		tituloLargo = "INFORMES";
		tituloCorto = "Comercios con Pagos por Transferencia";

		return "transferenciasLinkComercios";
	}
	...
	public void detalleConsultaTransferencia(ActionEvent event) {
		popupReport = new String("");
		if (validarFecha()) {
			HttpServletRequest request = Session.getRequest();
			...
			String page = request.getContextPath() + "/report/ConsultaTransferenciasClientes.jrxml";
			popupReport = "popup('" + page + p1 + p2 + p3 + "',1000,600)";
	...
	public void transferenciasLinkError(ActionEvent event) {
		popupReport = new String("");
		if (validarFecha()) {
			HttpServletRequest request = Session.getRequest();
			...
			String page = request.getContextPath() + "/report/ConsultaTransferenciasErrores.jrxml";
			popupReport = "popup('" + page + p1 + p2 + p3 + "',1000,600)";
	...
	public void transferenciasLinkComercios(ActionEvent event) {
		popupReport = new String("");
		if (validarFecha()) {
			HttpServletRequest request = Session.getRequest();
...
//			p2 = "&fecha_hasta=" + dateFormat.format(fechaHasta);
			...
			String page = request.getContextPath() + "/report/ComerciosPagosTransferencias.jrxml";
			popupReport = "popup('" + page +  p3 + "',1000,600)";
