...
public class PagoElectronicoDebinServlet extends HttpServlet implements javax.servlet.Servlet {
	
	private static Logger logger = Logger.getLogger(PagoElectronicoServlet.class);
	 ...
	 */
	public PagoElectronicoDebinServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			logger.info("PROCESANDO PAGO ELECTRONICO");
			...
			String result = pagoClienteService.registrarPagoClienteDebinLink(importe, idCliente, repacta, cuotas, saldoRepactacion);
			if(result.equals("OK")){
