...
public class PagoElectronicoAquiCobroServlet extends HttpServlet implements javax.servlet.Servlet {
	
	private static Logger logger = Logger.getLogger(PagoElectronicoAquiCobroServlet.class);
	 ...
	 */
	public PagoElectronicoAquiCobroServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			logger.info("PROCESANDO PAGO ELECTRONICO AQUICOBRO");
			...
			String result = pagoClienteService.registrarPagoClienteBotonAquiCobro(importe, idCliente, repacta, cuotas, saldoRepactacion);
			if(result.equals("OK")){
