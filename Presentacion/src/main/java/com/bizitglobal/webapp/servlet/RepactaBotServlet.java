...
public class RepactaBotServlet extends HttpServlet implements javax.servlet.Servlet {
	
	private static Logger logger = Logger.getLogger(RepactaBotServlet.class);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String result = pagoClienteService.registrarRepactacionBot(importe, idCliente, repacta, cuotas, saldoRepactacion);
			if(result.equals("OK")){
