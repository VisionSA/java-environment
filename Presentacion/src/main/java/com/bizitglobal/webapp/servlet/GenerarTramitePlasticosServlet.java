...
public class GenerarTramitePlasticosServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
	private static final long serialVersionUID = 6584463924824216356L;
	private static final Logger log = Logger.getLogger(GenerarTramitePlasticosServlet.class);
	 ...
	 */
	public GenerarTramitePlasticosServlet() {
		super();
	}
	...
	private void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			bloqueoPlastico.setCuil(cuil);
			bloqueoPlastico.setIdTitular(new Long(idTitular));
			bloqueoPlastico.setApellidoNombres(apellidoNombres + " " + nombres);
			...
			if (!auxProc.isEmpty()) {
				...
				out.print("Termino la generacion del Tramite Reemplazo Plastico!!!<br>");
			}
		} catch (Exception e) {
