...
public class PagoElectronicoServlet extends HttpServlet implements javax.servlet.Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String result = pagoClienteService.registrarPagoClienteBotonLink(importe, idCliente, repacta, cuotas, saldoRepactacion);
			if(result.equals("OK")){
