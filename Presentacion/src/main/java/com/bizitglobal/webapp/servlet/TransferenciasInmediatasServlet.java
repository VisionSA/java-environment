...
public class TransferenciasInmediatasServlet extends HttpServlet implements javax.servlet.Servlet {
	
	private static Logger logger = Logger.getLogger(TransferenciasInmediatasServlet.class);
	 ...
	 */
	public TransferenciasInmediatasServlet() {
		super();
	}
