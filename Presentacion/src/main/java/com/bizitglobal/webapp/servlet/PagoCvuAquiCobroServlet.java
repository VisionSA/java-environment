...
public class PagoCvuAquiCobroServlet extends HttpServlet implements javax.servlet.Servlet {
	 ...
	 */
	public PagoCvuAquiCobroServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			logger.info("PROCESANDO PAGO CVU AQUICOBRO");
			...
			String result = pagoClienteService.registrarPagoClienteCvu(importe, idCliente, repacta, cuotas, saldoRepactacion);
			if(result.equals("OK")){
