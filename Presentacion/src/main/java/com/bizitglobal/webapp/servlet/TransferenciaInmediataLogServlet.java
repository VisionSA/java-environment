...
public class TransferenciaInmediataLogServlet extends HttpServlet implements javax.servlet.Servlet {
	
	private static Logger logger = Logger.getLogger(TransferenciaInmediataLogServlet.class);
	 ...
	 */
	public TransferenciaInmediataLogServlet() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			logger.info("PROCESANDO Transferencia inmediate Log");
			...
			LiqClienteService liqClienteService = (LiqClienteService) appContext.getBean("liqClienteService");
			...
			String result = pagoClienteService.registrarTransferenciaInmed(cbuOrigen,cbuDestino,importe, cliente,
