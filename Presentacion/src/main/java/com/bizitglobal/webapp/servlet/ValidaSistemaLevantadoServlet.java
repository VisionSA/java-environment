...
public class ValidaSistemaLevantadoServlet extends HttpServlet implements javax.servlet.Servlet {

  /**
	 * 
	 */
	private static final long serialVersionUID = -9166416935188731214L;
	private Logger log = Logger.getLogger(ValidaSistemaLevantadoServlet.class);

	public ValidaSistemaLevantadoServlet() {
		super();
	}
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp)
      throws IOException {
	  	...
	  	try{
			  ...
			  Integer cliente = 62359;			  
			  
			  String codigoBarraTres = null;
			  
			// TRABAJAMOS CON EL CODIGOBARRATRES CON EL CVU
				codigoBarraTres = gestorLiquidacionClienteService.buscarCVUdelCliente(cliente);
