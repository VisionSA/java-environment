...
public class PlanificadorNotificacionServlet extends HttpServlet implements javax.servlet.Servlet {
	...
	private void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String titulo = "TARJETA FIEL";
			
//			if(emailInCola.getPlanProcesoEmail().getIdPlan().intValue() == 34 || emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 35 || emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 40 ){
//				titulo = "TARJETA FIEL";
//			}
//			else if (emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 36 ){
//				titulo = "TARJETA FIEL - AUN NO ABONASTE";
//			}
//			else if (emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 37){
//				titulo = "TARJETA FIEL - RECORDATORIO DE PAGO";
//			}
//			else if(emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 38){
//				titulo = "TARJETA FIEL - REGULARIZACION DE DEUDA";
//			}
//			else if(emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 39){
//				titulo = "TARJETA FIEL - INTIMACION DE PAGO";
//			}
//			else if(emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 225){
//				titulo = "TARJETA FIEL - 2x1 EN PLAYCINEMAS";
//			}
//			else if(emailInCola.getPlanProcesoEmail().getIdPlan().intValue()  == 21){
//				titulo = "TARJETA FIEL - CUOTIFICA";
//			}
...
//					"}";
				...
				String msj = "" +
						...
						"\"client\" : " +
						"{" +
						"\"id\":"+ emailInCola.getIdIdentificador() + " " +						
						"}" +
							",\"notification\" : " +
							"{" +
								"\"title\":\""+ nombre + "\"," +
				...
				URL url = new URL("http://192.168.79:3000/send/notification");
				
				
//				http://192.168.79:3000/send/notification
...
//						//METODO COMENTADO PARA PROBAR COMO FUNCIONA EL ENVIO DE NOTIFICACION 22-06-2022
