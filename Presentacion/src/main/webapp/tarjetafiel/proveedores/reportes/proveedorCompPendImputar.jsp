			...
			<%-- INCLUDE PARA LOS ERRORES --%> 	
				...
				<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<h:panelGrid id="filtroUno" columns="3" align="center" width="500">
						<h:panelGroup>
							<h:outputText value="Código Proveedor Desde:" styleClass="texto"/>
						...
						<h:panelGroup>
							<h:outputText value="Código Proveedor Hasta:" styleClass="texto"/>
					...
					<h:panelGroup>
							<h:commandButton id="verInformeEnExcel" actionListener="#{ReporteProveedorCtaCteBean.generarComprobantesPendientesDeImputarAExcel}"
											 styleClass="btn btn-primary btn-flat pull-right" value="Exportar a Excel" style="margin-left:10px;"/>
							
							<h:commandButton id="verInforme" actionListener="#{ReporteProveedorCtaCteBean.generarComprobantesPendientesDeImputar}" 
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{ReporteProveedorCtaCteBean.comprobantesPendientesIngresar}") + `</li>`;
}
