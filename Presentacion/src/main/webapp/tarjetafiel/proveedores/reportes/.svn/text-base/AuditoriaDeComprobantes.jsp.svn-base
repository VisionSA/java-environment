...
<html lang="es">
<head>
    <title><h:outputText value="Tarjeta Fiel - Reporte (Auditora de Comprobantes)"/></title>
...
<body class="hold-transition skin-blue sidebar-mini" onload="${AuditoriaDeComprobantesBean.popupReport}">
...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Auditoría de Comprobantes</h3>
		</div>
...
<h:form id="generalForm">
			...
			<h:panelGrid columns="1" align="center">
				...
				<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<h:panelGrid id="filtroUno" columns="3" align="center" width="500">
						<h:panelGroup>
							<h:outputText value="Desde Operador:" styleClass="texto"/>
							<h:inputText id="operador_desde" value="#{AuditoriaDeComprobantesBean.operadorDesde}" 
						...
						<h:panelGroup>
							<h:outputText value="Hasta Operador:" styleClass="texto"/>
							<h:inputText id="operador_hasta" value="#{AuditoriaDeComprobantesBean.operadorHasta}" 
				               			 styleClass="bordeceldainferior" maxlength="11" size="11" 
				               			 style="width: 90px;margin-left:10px;" onfocus="encender(this);" onblur="apagar(this);"
				               			 onkeypress="return soloEnteros(this,event);"/>
						</h:panelGroup>		
					...
					<h:panelGroup>
							<h:commandButton id="verInformeEnExcel" actionListener="#{AuditoriaDeComprobantesBean.generarAExcel}"
											 styleClass="btn btn-primary btn-flat pull-right" value="Exportar a Excel" style="margin-left:10px;"/>
							
							<h:commandButton id="verInforme" actionListener="#{AuditoriaDeComprobantesBean.generar}" 
											 value="Ver Reporte" styleClass="btn btn-primary btn-flat pull-right" style="margin-left:10px;"/>
					</h:panelGroup>			
					</h:panelGrid>
    ...
    <h:inputText id="FechaDesde" value="#{AuditoriaDeComprobantesBean.fechaDesde}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
    <h:inputText id="FechaHasta" value="#{AuditoriaDeComprobantesBean.fechaHasta}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{AuditoriaDeComprobantesBean.inicializar}") + `</li>`;
}
