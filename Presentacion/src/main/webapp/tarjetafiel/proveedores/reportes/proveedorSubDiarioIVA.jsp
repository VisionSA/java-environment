...
<html lang="es">
<head>
    <title><h:outputText value="Tarjeta Fiel - Reporte (Subdiario I.V.A. Compras - Detallado)"/></title>
...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Subdiario IVA compras - Detallado</h3>
		</div>
        ...
        <f:facet name="body">
			...
			<%-- INCLUDE PARA LOS ERRORES --%> 	
				...
				<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<h:panelGroup>
						<h:commandButton id="verInformeEnExcel" actionListener="#{ReporteProveedorCtaCteBean.generarSubdiarioIVAAExcel}"
											 styleClass="btn btn-primary btn-flat pull-right" style="margin-left:10px;" value="Exportar a Excel" />
						<h:commandButton id="verInforme" actionListener="#{ReporteProveedorCtaCteBean.generarSubdiarioIVA}" 
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{ReporteProveedorCtaCteBean.proveedoresSubdiarioIVA}") + `</li>`;
}
