			...
			<f:facet name="body">
				<h:panelGroup id="body">
			        ...
			        <h:panelGrid id="panelResumen" rendered="#{LiquidacionClientesBean.sePuedeConfirmar}" columns="1" align="center" >
                         ...
                         <f:verbatim>&nbsp;</f:verbatim>
                         <h:outputText value="El número de liquidacion es #{LiquidacionClientesBean.liquidacionClientesEditada.idLiquidacionClientes}." styleClass="texto"  style="FONT-SIZE: large; color:green"/>
                         <h:outputText value="El proceso ha finalizado con éxito." styleClass="texto"  style="FONT-SIZE: large; color:green"/>
			             <f:verbatim>&nbsp;</f:verbatim>
                         <f:verbatim>&nbsp;</f:verbatim>
			        </h:panelGrid>
					...
					<h:panelGrid columns="6" width="727" id="panelBotonera">
						...
						<h:outputText value="Comunicación" styleClass="texto" />
						...
						<x:commandButton id="buttonPreLiquidar" value="Pre-Liquidación" rendered="#{LiquidacionClientesBean.preliquidacion}"  action="#{LiquidacionClientesBean.preliquidar}" styleClass="btn btn-primary btn-flat"/>
                    ...
                    <h:panelGrid columns="1" width="700" id="panelPreliquis" align="center">
                              <h:dataTable value="#{LiquidacionClientesBean.listaPreliquidacionesWrapper}"
										...
										<h:column>
											<f:facet name="header">
												<h:outputText value="Cierre Período" id="cierreP" styleClass="texto"  />
											</f:facet>
                                        ...
                                        <h:column>
											<x:commandLink value="Confirmar Liquidación" action="#{var.confirmarLiquidacion}" id="confirmarPreliquidacionLink">
											</x:commandLink>
										</h:column>
