			...
			<f:facet name="body">
				<h:panelGroup id="body">
					...
					<h:panelGrid columns="10" width="727" id="panelBotonera">
						...
						<f:verbatim>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</f:verbatim>
						<f:verbatim>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</f:verbatim>
						<x:commandButton id="buttonGrabar" value="Liquidar" rendered="#{LiquidacionComerciosParticularBean.hayParaLiquidar}" action="#{LiquidacionComerciosParticularBean.liquidarListas}" styleClass="btn btn-primary btn-flat"/>
