...
<html lang="es">
<head>
    <title><h:outputText value="Tarjeta Fiel | Reclamos BCRA"/></title>
...
<body class="hold-transition skin-blue sidebar-mini" onload="${ReclamosBCRABean.popupReport}">
<h:form id="mainMenu" style="display: none">
	...
	<div class="box-header">
		<h3 class="box-title">Reclamos BCRA</h3>
	</div>
<center>
...
<h:form id="saldoProveedoresForm">
			...
			<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<h:panelGrid id="filtroUno" columns="3" align="center" width="546">
					   <h:panelGroup>
						...
						<h:panelGroup>
							<h:commandButton actionListener="#{ReclamosBCRABean.generar}" 
    ...
    <h:inputText id="FechaDesde" value="#{ReclamosBCRABean.fechaDesde}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
    <h:inputText id="FechaHasta" value="#{ReclamosBCRABean.fechaHasta}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>    
</h:form>        
</center>
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{ReclamosBCRABean.inicializar}") + `</li>`;
}
