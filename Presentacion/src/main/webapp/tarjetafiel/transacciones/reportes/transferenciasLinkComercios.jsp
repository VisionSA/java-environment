...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Comercios con Pagos por Transferencia</h3>
		</div><br/>
        ...
        <f:facet name="body">
			...
			<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<h:panelGrid id="filtroUno" columns="1" align="center" width="546">
						...
						<h:panelGroup>
							<h:commandButton actionListener="#{InformesBean.transferenciasLinkComercios}" 
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{InformesBean.inicializarConceptoMensualCuota}") + `</li>`;
}
