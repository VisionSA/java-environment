				...
				<h:panelGroup id="body">
					...
					<x:commandLink id="listarCodComercio" action="#{CodComercioBean.irAListarCodComercio}" forceId="true" style="display: block;"/>
					   ...
					   <h:panelGrid id="documento" columns="5" align="center">
							<h:outputText id="outNroCuit" value="Número de Cuit: " styleClass="texto" />
						...
						<s:fieldset legend="Código Comercio" id="legPrincipalPanCuatro"  rendered="#{CodComercioBean.sucursalCargada}">
											<h:panelGrid id="panelPrincipalUnoCuatro" columns="6" width="828" align="center">
												
												<h:outputText id="outCodigoPosnet" value="Código Posnet:" styleClass="texto"/>
												<h:outputText id="codigoposnetFiltroCuatro"  value="#{CodComercioBean.codigoPosnet}" styleClass="texto"/>
...
<%-- 												style="width: 90px" onfocus="encender(this);" onblur="apagar(this);" disabled="#{CodComercioBean.edicion}"/> --%>
					...
					<x:panelTabbedPane id="tabbedTablas"  align="center" serverSideTabSwitch="false" width="800" style="height: 400">
							...
							<%-- GESTIONAR IMPUESTOS --%>							
				              <s:fieldset legend="Código Comercio" id="legPrincipalRetenciones"  rendered="#{CodComercioBean.sucursalCargada}">
