...
<html>
<head>
    <title><h:outputText value="Tarjeta Fiel - Asiento de Fondos"/></title>
...
<body  onload="ocultarFila(); cargarArrayCuentas(); balancearHaberYDebe(); document.getElementById('asientoPopupForm:comprobante').focus();" onbeforeunload="ShowWait('asientoPopupForm');">
...
<script languaje="javascript">
         ...
         var suma = 0;
         var sumaHaber = 0;
  		 var cadenaIni = "asientoPopupForm:listado:";
  		 var cadenaFin = ":deb";
         ...
         function agregarAModificar(a) {
  		 ...
  		 function balancear(event) {
		    ...
		    if (evento.keyCode == 13) {
  		    ...
  		    document.getElementById('asientoPopupForm:totDebeLote').value = redondea(suma, 2);
  		    cambiarColor();
  		 }
  		 function balancearHaber(event) {
		    ...
		    if (evento.keyCode == 13) {
  		    ...
  		    document.getElementById('asientoPopupForm:totHaberLote').value = redondea(sumaHaber, 2);
  		    cambiarColor();
  		    return true;
  		 }
  		 function balancearHaberYDebe() {
  		    ...
  		    document.getElementById('asientoPopupForm:totDebeLote').value = redondea(suma, 2);
  		    cambiarColor();
  		    for (i=0; document.getElementById('asientoPopupForm:listado:' + i + ':cod').value!=""; i++ ) {
		     	    for (j=0; j<listaDeCuentas.length;j++) {
 		 	    		if (listaDeCuentas[j]==document.getElementById('asientoPopupForm:listado:' + i + ':cod').value) {
							
							if (listaDeCuentas[j+2]=="S") {
								document.getElementById('asientoPopupForm:listado:' + i + ':verListado').style.display = '';
								document.getElementById('asientoPopupForm:listado:' + i + ':verListado').style.color = '#000000';
							} else {
								document.getElementById('asientoPopupForm:listado:' + i + ':verListado').style.display = 'none';
							}
						} 
					}
			}
  		 ...
  		 function cambiarColor() {
  		     if (document.getElementById('asientoPopupForm:totDebeLote').value==document.getElementById('asientoPopupForm:totHaberLote').value) {
				 document.getElementById('asientoPopupForm:balanceoLote').bgColor = document.getElementById('asientoPopupForm:botonera').bgColor;
  		     } else {
  		         document.getElementById('asientoPopupForm:balanceoLote').bgColor = "red";
  		     }
  		 }
		...
		function mostrarFila(i) {
		    ...
		    document.getElementById('asientoPopupForm:listado:' + i + ':cod').style.width = 30;
		    document.getElementById('asientoPopupForm:listado:' + i + ':cod').style.height = 20;
		    document.getElementById('asientoPopupForm:listado:' + i + ':cod').style.background = '#FFFFFF';
		    document.getElementById('asientoPopupForm:listado:' + i + ':cod').style.border = '1px solid #666666';
		    document.getElementById('asientoPopupForm:listado:' + i + ':cod').style.display = '';

		    document.getElementById('asientoPopupForm:listado:' + i + ':tit').style.width = 120;
		    document.getElementById('asientoPopupForm:listado:' + i + ':tit').style.height = 20;
		    document.getElementById('asientoPopupForm:listado:' + i + ':tit').style.background = '#FFFFFF';
		    document.getElementById('asientoPopupForm:listado:' + i + ':tit').style.border = '1px solid #666666';
		    document.getElementById('asientoPopupForm:listado:' + i + ':tit').style.display = '';

		    document.getElementById('asientoPopupForm:listado:' + i + ':deb').style.width = 100;
		    document.getElementById('asientoPopupForm:listado:' + i + ':deb').style.height = 20;
		    document.getElementById('asientoPopupForm:listado:' + i + ':deb').style.background = '#FFFFFF';
		    document.getElementById('asientoPopupForm:listado:' + i + ':deb').style.border = '1px solid #666666';
		    document.getElementById('asientoPopupForm:listado:' + i + ':deb').style.display = '';

		    document.getElementById('asientoPopupForm:listado:' + i + ':hab').style.width = 100;
		    document.getElementById('asientoPopupForm:listado:' + i + ':hab').style.height = 20;
		    document.getElementById('asientoPopupForm:listado:' + i + ':hab').style.background = '#FFFFFF';
		    document.getElementById('asientoPopupForm:listado:' + i + ':hab').style.border = '1px solid #666666';
		    document.getElementById('asientoPopupForm:listado:' + i + ':hab').style.display = '';

		    document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.width = 130;
		    document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.height = 20;
		    document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.background = '#FFFFFF';
		    document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.border = '1px solid #666666';
		    document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.display = '';


		    document.getElementById('asientoPopupForm:listado:' + i + ':eliminarDetalleLoteLink').style.display = '';
			return null;
		}
		
		function ocultarFila() {
		    for (var i = 0; i < 100; i++) {
		        if (document.getElementById('asientoPopupForm:listado:' + i + ':cod').value==null || document.getElementById('asientoPopupForm:listado:' + i + ':cod').value=="") {
			    	document.getElementById('asientoPopupForm:listado:' + i + ':cod').style.display = 'none';
			    	document.getElementById('asientoPopupForm:listado:' + i + ':tit').style.display = 'none';
			    	document.getElementById('asientoPopupForm:listado:' + i + ':deb').style.display = 'none';
			    	document.getElementById('asientoPopupForm:listado:' + i + ':hab').style.display = 'none';
			    	document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.display = 'none';
			        document.getElementById('asientoPopupForm:listado:' + i + ':verListado').style.display = 'none';
			    	document.getElementById('asientoPopupForm:listado:' + i + ':listadoDeCentros').style.display = 'none';
			    	document.getElementById('asientoPopupForm:listado:' + i + ':interno').style.display = 'none';
			    	document.getElementById('asientoPopupForm:listado:' + i + ':eliminarDetalleLoteLink').style.display = 'none';
		    	} else {
		    		document.getElementById('asientoPopupForm:leyendaNombre').style.display = 'none';
                        document.getElementById('asientoPopupForm:listado:' + i + ':cod').disabled = true;
                        document.getElementById('asientoPopupForm:listado:' + i + ':cod').style.background = '#dddddd';
                        var InputText = document.getElementById('asientoPopupForm:listado:' + i + ':hab');
	                    if (InputText.value!=""&&InputText.value!=null) { 
		  		      		valor = InputText.id.substring(InputText.id.length-3, InputText.id.length);
		  		      		if (valor == "hab") {
		  		      		    document.getElementById(InputText.id.substring(0,InputText.id.length-3) + "deb").disabled = true;
                        ...
                        InputText = document.getElementById('asientoPopupForm:listado:' + i + ':deb');
	                    if (InputText.value!=""&&InputText.value!=null) { 
		  		      		valor = InputText.id.substring(InputText.id.length-3, InputText.id.length);
		  		      		if (valor == "hab") {
		  		      		    document.getElementById(InputText.id.substring(0,InputText.id.length-3) + "deb").disabled = true;
		...
		function cargarArrayCuentas() {
			listaDeCuentas = document.getElementById('asientoPopupForm:tablaCuentas').value.split(":");
		}
	    ...
	    function captarEnterEnLeyenda(InputText, elEvento) {
		    ...
		    if (evento.keyCode == 13) {
		    	...
		    	var cadena = InputText.id;
		    	if (InputText.value == "" || InputText.value == null) {
		    		InputText.value = document.getElementById('asientoPopupForm:comprobante').value;
		    	}
		    	var cadenaAux;
		    	...
		    	if (cadenaFecha == ""||cadenaFecha == null) {
		    	   ...
		    	   if (cadenaFecha.length == 10) {
		    	        if (/^\d{2}\/\d{2}\/\d{4}$/.test(cadenaFecha)) {
		    	   			mostrarFila(0);
		    	   			document.getElementById('asientoPopupForm:listado:0:cod').focus();
 		 	       		}
 		 	       		return false;
 		 	       } else {
 		 	       		return false;
		...
		function verLeyenda(InputText) {
			if (InputText.value == "" || InputText.value == null) {
		    	document.getElementById('asientoPopupForm:leyendaNombre').style.display = '';
		    } else {
		    	document.getElementById('asientoPopupForm:leyendaNombre').style.display = 'none';
		    }
		}	
		...
		function verCentroCosto(CommandLink){
		     ...
		     document.getElementById('asientoPopupForm:listado:tly').style.display = 'none';
		     for (i=0;document.getElementById('asientoPopupForm:listado:' + i + ':ley')!=null ; i++ ) {
		     	document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.display = 'none';
		     	
		     }
		     document.getElementById('asientoPopupForm:listado:' + cc + ':verListado').style.display = 'none';
		     document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros').style.display = '';
		     document.getElementById('asientoPopupForm:listado:' + cc + ':interno').style.display = '';
		     
		     document.getElementById('asientoPopupForm:listado:' + cc + ':acepCentro').style.color = '#000000';
		     document.getElementById('asientoPopupForm:listado:' + cc + ':acepCancel').style.color = '#000000';
		     document.getElementById('asientoPopupForm:listado:' + cc + ':acepTotal').style.color = '#000000';
		     
		     document.getElementById('asientoPopupForm:listado:' + cc + ':totalCostos').style.width = 50;
		     document.getElementById('asientoPopupForm:listado:' + cc + ':totalCostos').style.height = 18;
		     document.getElementById('asientoPopupForm:listado:' + cc + ':totalCostos').style.background = '#FFFFFF';
		     document.getElementById('asientoPopupForm:listado:' + cc + ':totalCostos').style.border = '1px solid #666666';
		     document.getElementById('asientoPopupForm:listado:' + cc + ':totalCostos').style.display = '';
		   <%-- var elem = document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:0:codCenCos');
		     if (elem!=null) { --%>
		         for (num = 0; document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:' + num + ':codCenCos')!=null; num++) {
		         	document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:' + num + ':codCenCos').style.color = '#000000';
		            document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:' + num + ':titDos').style.width = 50;
		            document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:' + num + ':titDos').style.height = 18;
		            document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:' + num + ':titDos').style.background = '#FFFFFF';
		            document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:' + num + ':titDos').style.border = '1px solid #666666';
		            document.getElementById('asientoPopupForm:listado:' + cc + ':listadoDeCentros:' + num + ':titDos').style.display = '';
		           
		         }

		         var colDebe = document.getElementById('asientoPopupForm:listado:' + cc + ':deb').value;
 		 	     var colHaber = document.getElementById('asientoPopupForm:listado:' + cc + ':hab').value;
 		 	     if (colDebe!=null && colDebe!="") {
 		 	     	cc = parseFloat(colDebe);
 		 	     } else {
 		 	        cc = parseFloat(colHaber);
 		 	     }
		         comprobarSuma(document.getElementById('asientoPopupForm:listado:0:listadoDeCentros:0:titDos'),cc);
		     <%-- }--%>
		     return false;
		}
		    ...
		    if (evento.keyCode == 13) {
		    	...
		    	var nume = InputText.id.substring(48,InputText.id.length-7);
 		 	    ...
 		 	    if (comprobarSuma(InputText, cc)) {
		    		document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':verListado').style.display = '';
		  		    document.getElementById('asientoPopupForm:listado:tly').style.display = '';
		  		    for (i=0; i <= document.getElementById('asientoPopupForm:listado:' + i + ':cod').value!=""; i++ ) {
		     			document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.display = '';

		     		}
		 		    document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':listadoDeCentros').style.display = 'none';
		 		    document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':interno').style.display = 'none';
		 		    document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':ley').focus();
 		 	    } else {
 		 	        var x = parseInt(nume);
 		 	        x = parseInt(x) + 1;
		...
		function cancelarCuentas(cad) {
			...
			document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':verListado').style.display = '';
		  	document.getElementById('asientoPopupForm:listado:tly').style.display = '';
		  	for (j=0; document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':listadoDeCentros:' + j + ':titDos')!=null;j++) {
		  	    document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':listadoDeCentros:' + j + ':titDos').value = 0;
		  	}
		  	document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':totalCostos').value = "";
		  	for (i=0; document.getElementById('asientoPopupForm:listado:' + i + ':cod').value!=""; i++ ) {
		     	document.getElementById('asientoPopupForm:listado:' + i + ':ley').style.display = '';
		     	if (document.getElementById('asientoPopupForm:listado:' + i + ':cod').value!="") {
		     	    for (j=0; j<listaDeCuentas.length;j++) {
 		 	    		if (listaDeCuentas[j]==document.getElementById('asientoPopupForm:listado:' + i + ':cod').value) {
		...
		function aceptarCuentas(cad) {
			var inicioCadena = cad.substring(29,cad.length - 11);
			if (document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':listadoDeCentros:0:titDos')!=null) {
			    var cc = parseInt(inicioCadena);
 		 	    var colDebe = document.getElementById('asientoPopupForm:listado:' + cc + ':deb').value;
 		 	    var colHaber = document.getElementById('asientoPopupForm:listado:' + cc + ':hab').value;
 		 	    if (colDebe!=null && colDebe!="") {
				...
				if (comprobarSuma(document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':listadoDeCentros:0:titDos'), cc)) {
			 		document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':verListado').style.display = '';
		  			document.getElementById('asientoPopupForm:listado:tly').style.display = '';
		  			document.getElementById('asientoPopupForm:listado:' + inicioCadena + ':totalCostos').value = "";
		  			for (i=0; document.getElementById('asientoPopupForm:listado:' + i + ':cod').value!=""; i++ ) {
		...
		function desabilitarHermano(SelectBooleanCheckbox) {
			...
			if (document.getElementById('asientoPopupForm:asientoDeCierre')!=null) {
				document.getElementById('asientoPopupForm:asientoDeCierre').checked = false;
			}
			if (document.getElementById('asientoPopupForm:asientoDeApertura')!=null) {
				document.getElementById('asientoPopupForm:asientoDeApertura').checked = false;
			}
...
<center>
<h:form id="asientoPopupForm"  style="width: 800;">
