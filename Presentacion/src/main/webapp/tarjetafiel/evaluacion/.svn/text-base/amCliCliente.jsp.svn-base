...
<body class="skin-blue layout-top-nav" onbeforeunload="ShowWait('amCliClienteForm');" onload="if('${CliClienteBean.popup.mostrar}'=='true') {viewDialog.show();} else {window.scrollTo(0,${ScrollBean.hiddenScrollY});}">
