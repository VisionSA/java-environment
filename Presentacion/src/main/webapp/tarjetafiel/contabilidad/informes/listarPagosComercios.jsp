...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Listar Pagos Comercios</h3>
		</div><br/>
    ...
    <x:panelLayout id="page" layout="#{globalOptions.pageLayout}"
        ...
        <f:facet name="body">
			...
			<s:layoutingTitlePane id="filtroProveedores"
					...
					<h:panelGrid id="filtroUno" columns="3" align="center" width="300">					   
						...
						<f:verbatim>&nbsp;</f:verbatim>
							...
							<h:commandButton actionListener="#{InformesBean.listarPagosComercios}" 
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{InformesBean.inicializarPagosComercios}") + `</li>`;
}
