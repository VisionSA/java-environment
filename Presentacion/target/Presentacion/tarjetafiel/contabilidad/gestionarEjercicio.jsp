                    ...
                    <h:panelGrid columns="1" id="uno" width="850" align="center">
						...
						<s:fieldset id="fieldParaAlta" legend="Alta de Ejercicio">
							...
							<h:panelGrid id="panlDeObservaciones" columns="3" align="center">
								...
								<x:commandButton action="#{EjercicioBean.grabarEjercicio}" id="botonSumbitGrabarEjercicio" value="Grabar Ejercicio" styleClass="btn btn-primary btn-flat" rendered="#{EjercicioBean.grabaEjercicio}"/>
						...
						<s:fieldset legend="Ejercicios Existentes ">
							...
							<h:dataTable value="#{EjercicioBean.ejercicios}" align="center"  title="Ejercicios Existentes"
									...
									var="objetoEjercicio" style=" width : 700px;">
									...
									<h:column>
										<f:facet name="header">
											<h:outputText value="Actual" styleClass="texto" />
										</f:facet>
										<h:outputText value="#{objetoEjercicio.ejercicio.actual}"/>
									</h:column>
									
									<h:column>
									<f:facet name="header">
											<h:outputText value="Activar" styleClass="texto" />
										</f:facet>
										<x:commandLink id="actualEjercicioLink"  action="#{EjercicioBean.grabarEjercicio}" >
											<x:graphicImage value="/img/editar.gif" title="Actualzar un Ejercicio." border="0" id="botonImagenTresA" />
											<f:param id="idEjeEdi1" name="idEjeEdi" value="#{objetoEjercicio.idEjer}"/>
										</x:commandLink>
									</h:column>
									...
									<h:column>
									<f:facet name="header">
											<h:outputText value="Modi_Cerrar" styleClass="texto" />
										</f:facet>
										<x:commandLink id="editarEjercicioLink"  action="#{EjercicioBean.modificarEjercicio}" >
											<x:graphicImage value="/img/borrar.gif" title="Editar un Ejercicio." border="0" id="botonImagenTresA" />
