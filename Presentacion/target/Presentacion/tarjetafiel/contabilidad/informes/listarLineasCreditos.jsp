...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Lineas de Crédito entre meses</h3>
		</div><br/>
<center>
			...
			<s:layoutingTitlePane id="filtroProveedores"
					...
					<h:panelGrid id="filtroUno" columns="3" align="center" width="546">
					   <h:panelGroup>
						...
						<h:panelGroup>
							<h:commandButton actionListener="#{InformesBean.detalleLineaCredito}" 
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{InformesBean.inicializarListadoLineaCredito}") + `</li>`;
}
