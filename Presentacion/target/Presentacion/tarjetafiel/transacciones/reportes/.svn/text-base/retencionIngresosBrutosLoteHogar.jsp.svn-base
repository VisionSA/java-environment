...
<html lang="es">
<head>
    <title><h:outputText value="Tarjeta Fiel | Reporte (Retencion Ingresos Brutos-Lote Hogar)"/></title>
...
<body class="hold-transition skin-blue sidebar-mini" onbeforeunload="ShowWait('generalForm');" onload="${RetencionIngresosBrutosLoteHogarBean.popupReport}">
...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Retención Comercio IIBB y Lote Hogar</h3>
		</div><br/>
...
<h:form id="generalForm">
        ...
        <f:facet name="body">
			...
			<%-- INCLUDE PARA LOS ERRORES --%> 	
				...
				<s:layoutingTitlePane id="filtroProveedores"
					...
					<h:commandButton actionListener="#{RetencionIngresosBrutosLoteHogarBean.generarRetencionIngresosBrutosLoteHogar}" 
											 value="Generar DJ IIBB" styleClass="btn btn-primary btn-flat pull-right"/>
    ...
    <h:inputText id="FechaDesde" value="#{RetencionIngresosBrutosLoteHogarBean.fechaDesde}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
    <h:inputText id="FechaHasta" value="#{RetencionIngresosBrutosLoteHogarBean.fechaHasta}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{RetencionIngresosBrutosLoteHogarBean.inicializar}") + `</li>`;
}
