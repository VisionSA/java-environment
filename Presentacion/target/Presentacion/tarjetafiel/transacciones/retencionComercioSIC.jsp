...
<html lang="es">
<head>
    <title><h:outputText value="Tarjeta Fiel - Reporte (Retencion Comercio SICORE)"/></title>
...
<body class="hold-transition skin-blue sidebar-mini" onbeforeunload="ShowWait('generalForm');" onload="${RetencionComercioSICOREBean.popupReport}">
...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Retención Comercio SICORE</h3>
		</div><br/>	
...
<h:form id="generalForm">
				...
				<s:layoutingTitlePane id="filtroProveedores"  
					...
					<h:panelGrid id="filtroUno" columns="3" align="center" width="546">
					   <h:panelGroup>
						...
						<h:panelGroup>
							<h:commandButton actionListener="#{RetencionComercioSICOREBean.generarRetencionComercioSICORE}" 
    ...
    <h:inputText id="FechaDesde" value="#{RetencionComercioSICOREBean.fechaDesde}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
    <h:inputText id="FechaHasta" value="#{RetencionComercioSICOREBean.fechaHasta}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
	...
	for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
	    ...
	    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{RetencionComercioSICOREBean.inicializar}") + `</li>`;
	}
