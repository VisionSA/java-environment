...
<section class="content">
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">Nómina de Proveedores</h3>
		</div>
        ...
        <f:facet name="body">
			...
			<%-- INCLUDE PARA LOS ERRORES --%> 	
				...
				<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<h:panelGroup>
						<h:commandButton id="verInformeEnExcel" actionListener="#{ReporteProveedorCtaCteBean.generarNominasProveedorAExcel}"
											 styleClass="btn btn-primary btn-flat pull-right" style="margin-left:10px;" value="Exportar a Excel" />
						<h:commandButton id="verInforme" actionListener="#{ReporteProveedorCtaCteBean.generarNominasProveedor}" 
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{ReporteProveedorCtaCteBean.nominasProveedores}") + `</li>`;
}
