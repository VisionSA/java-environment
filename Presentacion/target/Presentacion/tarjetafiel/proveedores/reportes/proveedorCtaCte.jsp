...
<html lang="es">
<head>
    <title><h:outputText value="Tarjeta Fiel - Reporte (Proveedores Cta Cte)"/></title>
				...
				<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<h:panelGrid id="filtroUno" columns="3" align="center" width="500">
						<h:panelGroup>
							...
							<x:inputText id="cuitFiltro" value="#{ReporteProveedorCtaCteBean.cuit}" 
		        		...
		        		<x:commandLink id="buscarProveedorLink" action="#{ReporteProveedorCtaCteBean.buscarProveedorPopup}">
					...
					<h:panelGroup>
						<h:commandButton id="verInformeEnExcel" actionListener="#{ReporteProveedorCtaCteBean.generarAExcel}"
											 styleClass="btn btn-primary btn-flat pull-right" style="margin-left:10px;" value="Exportar a Excel" />
						<h:commandButton id="verInforme" actionListener="#{ReporteProveedorCtaCteBean.generar}" 
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{ReporteProveedorCtaCteBean.inicializar}") + `</li>`;
}
