...
<html lang="es">
<head>
	<title><h:outputText value="Tarjeta Fiel | Reporte (Fondos Movimiento Caja)"/></title>
...
<div class="box-header with-border">
	<h3 class="box-title">Fondos Movimientos Caja</h3>
</div>
<br/>
			...
			<f:facet name="body">
				<h:panelGroup id="body">
					...
					<x:commandLink id="aceptarOK" forceId="true" style="display: block;"/>
					    <s:fieldset legend="Movimientos de Caja" id="primerField">
						...
						<f:verbatim><hr align="center" width="700"></f:verbatim>
								<h:panelGrid id="botonFiltros" columns="8"> 
							      ...
							      <f:verbatim>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</f:verbatim>
				 				<x:commandLink id="exportarExcelLink"  action="#{LibroMayorFondosBean.generarMovAExcel}">
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{LibroMayorFondosBean.inicializarMovimientos}") + `</li>`;
}
