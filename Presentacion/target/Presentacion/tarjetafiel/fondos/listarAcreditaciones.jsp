...
<h:form id="saldoProveedoresForm">
        ...
        <f:facet name="body">
			...
			<s:layoutingTitlePane id="filtroProveedores" label=" Filtro Reporte" 
					...
					<f:verbatim><br></f:verbatim>
						<h:panelGrid columns="7" align="center" width="546">
						...
						<f:verbatim>&nbsp;</f:verbatim>
						<h:panelGrid id="filtrodos" columns="3" align="center" width="546">
                        ...
                        <h:panelGrid columns="2" align="center" width="546">
								<h:selectOneRadio value="#{AcreditacionesBean.tipoLista}" id="tipoAcreditacionParaFiltro" styleClass="radioB">
								    <f:selectItem itemLabel="Acreditaciones Pendientes" itemValue="N" />
								    <f:selectItem itemLabel="Acreditaciones Enviadas" itemValue="S" />
							    </h:selectOneRadio>
						</h:panelGrid>  
						
						<f:verbatim><hr align="center" width="600"></f:verbatim> 
						<h:commandButton actionListener="#{AcreditacionesBean.listarAcreditaciones}" 
    ...
    <h:inputText id="FechaDesde" value="#{AcreditacionesBean.fechaDesde}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
    <h:inputText id="FechaHasta" value="#{AcreditacionesBean.fechaHasta}" style="display: none;">
        <f:convertDateTime type="both" pattern = "dd/MM/yyyy HH:mm"/>
    </h:inputText>
...
for(var i = 1; i < mainMenu__idJsp2_menu.length-1; i++) {
    ...
    document.getElementById("sideMenu").innerHTML += generateMenu(obj,"mainMenu__idJsp2_menu:A]\#{AcreditacionesBean.inicializar}") + `</li>`;
}
