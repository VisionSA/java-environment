...
<body onbeforeunload="ShowWait('buscarIndividuoModificacionCuentaForm');">
<center>
<h:form id="buscarIndividuoModificacionCuentaForm">
...
<x:panelTabbedPane bgcolor="#dcdcdc" align="center">
	<h:panelGroup id="buscarIndividuo">
		...
		<h:panelGrid columns="2" id="PrimerPanelBusqueda" width="600" align="center">
			...
			<h:panelGroup>
				<x:inputText id="inNroCuilPopap" forceId="true" value="#{ModificacionEstructuraCuentaBean.cuilBuscador}" size="11"
				...
				<x:commandButton id="buscarInLink" action="#{ModificacionEstructuraCuentaBean.buscadorDeIndividuo}" value="Buscar" styleClass="botones"/>				
			</h:panelGroup>
		</h:panelGrid>
		...
		<h:panelGrid columns="4" id="panelSecuandarioPopap" align="center" width="600">
			...
			<h:outputText id="txtApel" value="#{ModificacionEstructuraCuentaBean.apel}" styleClass="textoblue"/>
			<h:outputText id="outNombrePopap" value="Nombres: " styleClass="texto" />
			<h:outputText id="txtNom" value="#{ModificacionEstructuraCuentaBean.nom}" styleClass="textoblue"/>
				
		</h:panelGrid>
			
		<h:panelGrid columns="2" width="400" align="center">
			<x:commandButton value="Aceptar" disabled="#{!ModificacionEstructuraCuentaBean.habilitarCarga}" action="#{ModificacionEstructuraCuentaBean.recargarYCerrarPopup}" 
			...
			<x:commandButton action="#{ModificacionEstructuraCuentaBean.buscarOtroIndividuo}" value="Cancelar" styleClass="botones" title="Continuar con el alta del individuo."/>
