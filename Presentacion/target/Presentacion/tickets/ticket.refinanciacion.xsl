...
%centrar%REFINANCIACION DE SALDO

Importe a refinanciar: <xsl:value-of select="refinanciacion/moneda"/> <xsl:value-of select="format-number(refinanciacion/importe, '##.##0,00', 'pesoFormat')"/>
