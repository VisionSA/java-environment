...
*/
public class JurisTipoImpuestoException extends Exception {
	/**
	* Constructor por defecto de la excepción.
	* @param msg, Mensaje descriptivo de la excepción.
	*/
	public JurisTipoImpuestoException (String msg) {
	...
	*/
	public JurisTipoImpuestoException (String msg, Throwable cause) {
