 ...
 * @author Daniel
 */
public class JurisdiccionActividadDuplicateException extends JurisdiccionActividadException {
	 ...
	 */
	public JurisdiccionActividadDuplicateException(String msg, Throwable cause) {
		super(msg,cause);
	}
