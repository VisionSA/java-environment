...
*/
public class JurisTipoImpuestoNotFoundException extends JurisTipoImpuestoException {
	...
	*/
	public JurisTipoImpuestoNotFoundException (String msg, Throwable cause) {
