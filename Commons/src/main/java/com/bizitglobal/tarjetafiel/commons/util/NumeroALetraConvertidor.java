 ...
 * @version 1.0
 */
public abstract class NumeroALetraConvertidor {
	...
	public static String convertNumberToLetter(String number)throws NumberFormatException {
		return convertNumberToLetter(new Double(number).doubleValue());
	}
...
//	converted += "PESOS"; // Comentada por Hernan. No requerido
