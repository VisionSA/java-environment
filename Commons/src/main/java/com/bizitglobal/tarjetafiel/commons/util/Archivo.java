...
private static Calendar calendar;
	...
	*/
	...
	public static String grabarArchivoComercio(InputStream in, String name, int maxUploadFile, String directorioInmediato,String adelante){ 
		try {
			calendar = Calendar.getInstance();
			String nameImage = adelante + "-" + name;
			String key;
			key = "catalina.home";
			key = System.getProperty(key);
			log.info(key +"/webapps/contexto.properties");
		...
		//	return nameImage;
			...
			return key +"/" + prop.getProperties("directorioArchivos") + "/" + directorioInmediato + "/" + nameImage;
