...
*/
public class CajaMPException extends Exception {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2578612862953060757L;
	/**
	* Constructor por defecto de la excepcion.
	* @param msg, Mensaje descriptivo de la excepcion.
	*/
	public CajaMPException (String msg) {
	...
	*/
	public CajaMPException (String msg, Throwable cause) {
