...
*/
public class ExtractoBancarioException extends Exception {
	/**
	 * 
	 */
	...
	*/
	public ExtractoBancarioException (String msg) {
	...
	*/
	public ExtractoBancarioException (String msg, Throwable cause) {
