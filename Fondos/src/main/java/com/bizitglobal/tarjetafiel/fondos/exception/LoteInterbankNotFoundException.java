...
*/
public class LoteInterbankNotFoundException extends LoteInterbankException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 315067158864984500L;
	...
	*/
	public LoteInterbankNotFoundException (String msg, Throwable cause) {
