...
*/
public class ChequeLugarNotFoundException extends ChequeLugarException {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4379543812458510376L;
	...
	*/
	public ChequeLugarNotFoundException (String msg, Throwable cause) {
