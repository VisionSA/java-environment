...
*/
public class AcreditacionFondoException extends Exception {
	/**
	 * 
	 */
	...
	*/
	public AcreditacionFondoException (String msg) {
	...
	*/
	public AcreditacionFondoException (String msg, Throwable cause) {
