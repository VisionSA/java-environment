...
*/
public class MovimientoMPException extends Exception {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3412045941767069746L;
	/**
	* Constructor por defecto de la excepcion.
	* @param msg, Mensaje descriptivo de la excepcion.
	*/
	public MovimientoMPException (String msg) {
	...
	*/
	public MovimientoMPException (String msg, Throwable cause) {
