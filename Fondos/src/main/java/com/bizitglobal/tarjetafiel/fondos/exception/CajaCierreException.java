...
*/
public class CajaCierreException extends Exception {
	/**
	 * 
	 */
	private static final long serialVersionUID = 683307372365803106L;
	/**
	* Constructor por defecto de la excepcion.
	* @param msg, Mensaje descriptivo de la excepcion.
	*/
	public CajaCierreException (String msg) {
	...
	*/
	public CajaCierreException (String msg, Throwable cause) {
