...
public class TipoParamTempEmailException extends Exception {
	 ...
	 */
	public TipoParamTempEmailException(String msg) {
		super(msg);
	}
	 ...
	 */
	public TipoParamTempEmailException(String msg, Throwable cause) {
		super(msg, cause);
	}
