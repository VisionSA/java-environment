package views.categorias.cliente.models
{
	...
	{  
	   ...
	   public var arrayMovientoComercioDetalles:ArrayCollection;
	   public var arrayMovientoComercioDetallesCom:ArrayCollection;
	   public var arrayMovientoPendiente:ArrayCollection;
	   public var arrayMovientoPendienteComp:ArrayCollection;
	   public var arrayMovientoComposDetalles:ArrayCollection;
	   public var movTransaccionCliCom:MovTransaccionCliCom;
	   public var movTransaccionCliComCompos:MovTransaccionCliCom;
	   public var arrayComposicionDetalleCtaCteCom:ArrayCollection;
	   ...
	   public var movimientoCtaCteSeleccionadoCompos: MovimientoCtaCte;
	   public var detalleMovimientoCtaCteSeleccionado: MovimientoCtaCteDetalle;
	   public var detallemovimientoCtaCteSeleccionadoCompos: MovimientoCtaCteDetalle;
	   ...
	   public var rutaDetalleIntereses:String;
	 ...
	 public  function getSaldoAcumulado(valor:Number):void{
	  ...
	  public function  buscarMovimientosPendientes():void{
	  ...
	  public function  buscarMovimientosPendientesComp():void{
		  
		  if(titular){
			  acumulado = 0; 
			  var evt:ClienteManagerEvent = new ClienteManagerEvent(ClienteManagerEvent.BUSCAR_DETALLES_MOVIMIENTO_PENDIENTE_COMP);
	  ...
	  public function  buscarDetallesMovimientoCompos():void{
		  if(movimientoCtaCteSeleccionadoCompos){
			  var evt:ClienteEvent = new ClienteEvent(ClienteEvent.BUSCAR_DETALLES_MOVIMIENTO_COMPOS_CLIENTE);
			  evt.idTransaccion = movimientoCtaCteSeleccionadoCompos.idTransaccion;
			  evt.idCliente=  titular.idCliente;
			  evt.idTipoConceptoDetalle= null; 
			  dispatcher.dispatchEvent(evt);
		  }
		  ControlBlock.getInstance().add();
	  }
	  ...
	  public function  buscarTransaccionCliCom():void{
		  if(movimientoCtaCteSeleccionado){
			  var evt:ClienteEvent = new ClienteEvent(ClienteEvent.BUSCAR_TRANSACCION_CLI_COM);
	  ...
	  public function  buscarTransaccionCliComCompos():void{
		  if(movimientoCtaCteSeleccionadoCompos){
			  var evt:ClienteEvent = new ClienteEvent(ClienteEvent.BUSCAR_TRANSACCION_CLI_COM_COMP);
	  ...
	  public function  buscarDetallesMovimientoComercio():void{
		  if(movimientoCtaCteSeleccionado){
			  var evt:ClienteEvent = new ClienteEvent(ClienteEvent.BUSCAR_DETALLES_MOVIMIENTO_CTA_CTE_COMERCIO);
			  evt.idTransaccion = movimientoCtaCteSeleccionado.idTransaccion;
			  dispatcher.dispatchEvent(evt);
		  }
		  ControlBlock.getInstance().add();
	  ...
	  public function  buscarDetallesMovimientoComercioCom():void{
		  if(movimientoCtaCteSeleccionadoCompos){
			  var evt:ClienteEvent = new ClienteEvent(ClienteEvent.BUSCAR_DETALLES_MOVIMIENTO_CTA_CTE_COMERCIO_COMP);
			  evt.idTransaccion = movimientoCtaCteSeleccionadoCompos.idTransaccion;
			  dispatcher.dispatchEvent(evt);
		  }
		  ControlBlock.getInstance().add();
	   ...
	   public function buscarComposicionDetalleComp():void{
		   if(detallemovimientoCtaCteSeleccionadoCompos && movimientoCtaCteSeleccionadoCompos){
			   var evt:ClienteEvent = new ClienteEvent(ClienteEvent.BUSCAR_COMPOSICION_DETALLE_CTA_CTE_CLIENTE_COMP);
			   evt.idTransaccion = movimientoCtaCteSeleccionadoCompos.idTransaccion;
			   evt.idCliente=  titular.idCliente; 
			   evt.idConceptoDetalle= detallemovimientoCtaCteSeleccionadoCompos.idConceptoDetalle;
			   dispatcher.dispatchEvent(evt);
		   }
		   ControlBlock.getInstance().add();
	   }	
