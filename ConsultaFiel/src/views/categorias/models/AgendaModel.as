package views.categorias.models
{
	...
	{
		//
		public var mostrarPanel :  Boolean= true;
		...
		public function guardarNuevoEvento(eventoCliente :EventosCliente):void{
			...
			evt.evento = eventoCliente;
			evt.operador = Application.application.parameters.codigoOperador;
			dispatcher.dispatchEvent(evt);
			
		}
		
		public function guardarNuevoEventoBloqueo(eventoCliente :EventosCliente):void{
			
			
			var evt:ClienteManagerEvent;
			
			evt = new ClienteManagerEvent(ClienteManagerEvent.HACER_BLOQUEO_DESBLOQUE);
		...
		public function guardarBloqueoTransfCliente(eventoCliente :EventosCliente):void{
			
			
			var evt:ClienteManagerEvent;
			
			evt = new ClienteManagerEvent(ClienteManagerEvent.HACER_DESBLOQUEO_APP);
		...
		public function buscarTodosEventosCliente():void{
			if(_titular == null){
				AlertWarning.show("No hay ningún cliente seleccionado");
				return;
			}
			
				var evt:EventosEvent = new EventosEvent(EventosEvent.BUSCAR_TODOSEVENTOS_CLIENTE);
				evt.idCliente = _titular.idCliente;
				dispatcher.dispatchEvent(evt);
